...
import { f as getRequest } from "./esm-BG-5H9y6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-middleware-bu9wKdsd.js
var requireSupabaseAuth = createMiddleware({ type: "function" }).server(async ({ next }) => {
	...
	if (!(request === null || request === void 0 ? void 0 : request.headers)) throw new Error("Unauthorized: No request headers available");
	...
	if (error || !(data === null || data === void 0 ? void 0 : data.claims)) throw new Error("Unauthorized: Invalid token");
