...
import { c as noop, i as notifyManager, l as shouldThrowError, n as MutationObserver, r as QueryObserver, s as environmentManager } from "./@tanstack/query-core.mjs";
...
function useBaseQuery(options, Observer, queryClient) {
	...
	if (defaultedOptions.experimental_prefetchInRender && !environmentManager.isServer() && willFetch(result, isRestoring)) {
		...
		promise === null || promise === void 0 || promise.catch(noop).finally(() => {
			observer.updateResult();
		});
	}
...
function useSuspenseQuery(options, queryClient) {
	return useBaseQuery(_objectSpread2(_objectSpread2({}, options), {}, {
		enabled: true,
		suspense: true,
