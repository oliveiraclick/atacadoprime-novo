...
function createSlot(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		var _slottableElement$pro2;
		let { children } = props, slotProps = _objectWithoutProperties(props, _excluded$7);
		...
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable(maybeSlottable)) {
				var _slottableElement$pro;
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent(child) && typeof use === "function") child = use(child._payload);
				slottableElement = getSlottableElementFromSlottable(slottable, child);
				newChildren.push(slottableElement === null || slottableElement === void 0 || (_slottableElement$pro = slottableElement.props) === null || _slottableElement$pro === void 0 ? void 0 : _slottableElement$pro.children);
		...
		const mergedProps = mergeProps(slotProps, (_slottableElement$pro2 = slottableElement.props) !== null && _slottableElement$pro2 !== void 0 ? _slottableElement$pro2 : {});
...
function mergeProps(slotProps, childProps) {
	const overrideProps = _objectSpread2({}, childProps);
	for (const propName in childProps) {
		...
		} else if (propName === "style") overrideProps[propName] = _objectSpread2(_objectSpread2({}, slotPropValue), childPropValue);
...
var Primitive = [
	...
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild } = props, primitiveProps = _objectWithoutProperties(props, _excluded$6);
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Comp, _objectSpread2(_objectSpread2({}, primitiveProps), {}, { ref: forwardedRef }));
	});
	Node.displayName = `Primitive.${node}`;
	return _objectSpread2(_objectSpread2({}, primitive), {}, { [node]: Node });
}, {});
...
init_objectSpread2();
var _excluded2$2 = ["scope", "children"];
function createContextScope(scopeName, createContextScopeDeps = []) {
	...
	function createContext3(rootComponentName, defaultContext) {
		...
		const Provider = (props) => {
			...
			const { scope, children } = props, context = _objectWithoutProperties(props, _excluded2$2);
	...
	const createScope = () => {
		...
		return function useScope(scope) {
			...
			return import_react.useMemo(() => ({ [`__scope${scopeName}`]: _objectSpread2(_objectSpread2({}, scope), {}, { [scopeName]: contexts }) }), [scope, contexts]);
		};
	};
	...
	const createScope = () => {
		...
		return function useComposedScopes(overrideScopes) {
			const nextScopes = scopeHooks.reduce((nextScopes2, { useScope, scopeName }) => {
				...
				return _objectSpread2(_objectSpread2({}, nextScopes2), currentScope);
			}, {});
...
var _globalThis;
var useLayoutEffect2 = ((_globalThis = globalThis) === null || _globalThis === void 0 ? void 0 : _globalThis.document) ? import_react.useLayoutEffect : () => {};
//#endregion
...
function useId(deterministicId) {
	...
	useLayoutEffect2(() => {
		if (!deterministicId) setId((reactId) => reactId !== null && reactId !== void 0 ? reactId : String(count$1++));
	}, [deterministicId]);
...
function useCallbackRef$1(callback) {
	...
	return import_react.useMemo(() => ((...args) => {
...
var DismissableLayer = import_react.forwardRef((props, forwardedRef) => {
	var _node$ownerDocument, _globalThis;
	const { disableOutsidePointerEvents = false, deferPointerDownOutside = false, onEscapeKeyDown, onPointerDownOutside, onFocusOutside, onInteractOutside, onDismiss } = props, layerProps = _objectWithoutProperties(props, _excluded$4);
	const context = import_react.useContext(DismissableLayerContext);
	const [node, setNode] = import_react.useState(null);
	const ownerDocument = (_node$ownerDocument = node === null || node === void 0 ? void 0 : node.ownerDocument) !== null && _node$ownerDocument !== void 0 ? _node$ownerDocument : (_globalThis = globalThis) === null || _globalThis === void 0 ? void 0 : _globalThis.document;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.div, _objectSpread2(_objectSpread2({}, layerProps), {}, {
		ref: composedRefs,
		style: _objectSpread2({ pointerEvents: isBodyPointerEventsDisabled ? isPointerEventsEnabled ? "auto" : "none" : void 0 }, props.style),
...
var DismissableLayerBranch = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.div, _objectSpread2(_objectSpread2({}, props), {}, { ref: composedRefs }));
});
...
function usePointerDownOutside(onPointerDownOutside, args) {
	var _globalThis2;
	const { ownerDocument = (_globalThis2 = globalThis) === null || _globalThis2 === void 0 ? void 0 : _globalThis2.document, deferPointerDownOutside = false, isDeferredPointerDownOutsideRef, dismissableSurfaces } = args;
...
function useFocusOutside(onFocusOutside, ownerDocument = (() => {
	var _globalThis3;
	return (_globalThis3 = globalThis) === null || _globalThis3 === void 0 ? void 0 : _globalThis3.document;
})()) {
...
var FocusScope = import_react.forwardRef((props, forwardedRef) => {
	const { loop = false, trapped = false, onMountAutoFocus: onMountAutoFocusProp, onUnmountAutoFocus: onUnmountAutoFocusProp } = props, scopeProps = _objectWithoutProperties(props, _excluded$3);
		...
		if (container) {
			...
			return () => {
				...
				setTimeout(() => {
					...
					if (!unmountEvent.defaultPrevented) focus(previouslyFocusedElement !== null && previouslyFocusedElement !== void 0 ? previouslyFocusedElement : document.body, { select: true });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.div, _objectSpread2(_objectSpread2({ tabIndex: -1 }, scopeProps), {}, {
		ref: composedRefs,
...
init_objectSpread2();
var _excluded$2 = ["container"];
var PORTAL_NAME$2 = "Portal";
var Portal = import_react.forwardRef((props, forwardedRef) => {
	var _globalThis;
	const { container: containerProp } = props, portalProps = _objectWithoutProperties(props, _excluded$2);
	const [mounted, setMounted] = import_react.useState(false);
	useLayoutEffect2(() => setMounted(true), []);
	const container = containerProp || mounted && ((_globalThis = globalThis) === null || _globalThis === void 0 || (_globalThis = _globalThis.document) === null || _globalThis === void 0 ? void 0 : _globalThis.body);
	return container ? import_react_dom.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.div, _objectSpread2(_objectSpread2({}, portalProps), {}, { ref: forwardedRef })), container) : null;
});
...
function useFocusGuards() {
	import_react.useEffect(() => {
		...
		return () => {
			if (count === 1) {
				guards === null || guards === void 0 || guards.start.remove();
				guards === null || guards === void 0 || guards.end.remove();
				guards = null;
			}
...
init_objectSpread2();
var _excluded$1 = ["__scopeDialog"], _excluded2$1 = ["forceMount"], _excluded3$1 = ["__scopeDialog"], _excluded4$1 = ["forceMount"], _excluded5$1 = [
	"__scopeDialog",
	"trapFocus",
	"onOpenAutoFocus",
	"onCloseAutoFocus"
], _excluded6$1 = ["__scopeDialog"], _excluded7$1 = ["__scopeDialog"], _excluded8$1 = ["__scopeDialog"];
...
var DialogTrigger = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog } = props, triggerProps = _objectWithoutProperties(props, _excluded$1);
	const context = useDialogContext(TRIGGER_NAME$1, __scopeDialog);
	const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.button, _objectSpread2(_objectSpread2({
		type: "button",
...
var DialogOverlay = import_react.forwardRef((props, forwardedRef) => {
	...
	const { forceMount = portalContext.forceMount } = props, overlayProps = _objectWithoutProperties(props, _excluded2$1);
	const context = useDialogContext(OVERLAY_NAME$1, props.__scopeDialog);
	return context.modal ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		present: forceMount || context.open,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlayImpl, _objectSpread2(_objectSpread2({}, overlayProps), {}, { ref: forwardedRef }))
	}) : null;
});
DialogOverlay.displayName = OVERLAY_NAME$1;
var Slot = /* @__PURE__ */ createSlot("DialogOverlay.RemoveScroll");
var DialogOverlayImpl = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog } = props, overlayProps = _objectWithoutProperties(props, _excluded3$1);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReactRemoveScroll, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.div, _objectSpread2(_objectSpread2({ "data-state": getState(context.open) }, overlayProps), {}, {
			ref: composedRefs,
			style: _objectSpread2({ pointerEvents: "auto" }, overlayProps.style)
		}))
	});
});
...
var DialogContent = import_react.forwardRef((props, forwardedRef) => {
	...
	const { forceMount = portalContext.forceMount } = props, contentProps = _objectWithoutProperties(props, _excluded4$1);
	const context = useDialogContext(CONTENT_NAME$1, props.__scopeDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		present: forceMount || context.open,
		children: context.modal ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentModal, _objectSpread2(_objectSpread2({}, contentProps), {}, { ref: forwardedRef })) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentNonModal, _objectSpread2(_objectSpread2({}, contentProps), {}, { ref: forwardedRef }))
	});
});
...
var DialogContentModal = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContentImpl, _objectSpread2(_objectSpread2({}, props), {}, {
		ref: composedRefs,
...
var DialogContentImpl = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog, trapFocus, onOpenAutoFocus, onCloseAutoFocus } = props, contentProps = _objectWithoutProperties(props, _excluded5$1);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusScope, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DismissableLayer, _objectSpread2(_objectSpread2({
			role: "dialog",
...
var DialogTitle = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog } = props, titleProps = _objectWithoutProperties(props, _excluded6$1);
	const context = useDialogContext(TITLE_NAME$1, __scopeDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.h2, _objectSpread2(_objectSpread2({ id: context.titleId }, titleProps), {}, { ref: forwardedRef }));
});
DialogTitle.displayName = TITLE_NAME$1;
var DESCRIPTION_NAME$1 = "DialogDescription";
var DialogDescription = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog } = props, descriptionProps = _objectWithoutProperties(props, _excluded7$1);
	const context = useDialogContext(DESCRIPTION_NAME$1, __scopeDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.p, _objectSpread2(_objectSpread2({ id: context.descriptionId }, descriptionProps), {}, { ref: forwardedRef }));
});
DialogDescription.displayName = DESCRIPTION_NAME$1;
var CLOSE_NAME = "DialogClose";
var DialogClose = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeDialog } = props, closeProps = _objectWithoutProperties(props, _excluded8$1);
...
init_objectSpread2();
var _excluded = ["__scopeAlertDialog"], _excluded2 = ["__scopeAlertDialog"], _excluded3 = ["__scopeAlertDialog"], _excluded4 = ["__scopeAlertDialog"], _excluded5 = ["__scopeAlertDialog", "children"], _excluded6 = ["__scopeAlertDialog"], _excluded7 = ["__scopeAlertDialog"], _excluded8 = ["__scopeAlertDialog"], _excluded9 = ["__scopeAlertDialog"];
var ROOT_NAME = "AlertDialog";
var [createAlertDialogContext, createAlertDialogScope] = createContextScope(ROOT_NAME, [createDialogScope]);
var useDialogScope = createDialogScope();
var AlertDialog = (props) => {
	const { __scopeAlertDialog } = props, alertDialogProps = _objectWithoutProperties(props, _excluded);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, _objectSpread2(_objectSpread2(_objectSpread2({}, dialogScope), alertDialogProps), {}, { modal: true }));
};
AlertDialog.displayName = ROOT_NAME;
var TRIGGER_NAME = "AlertDialogTrigger";
var AlertDialogTrigger = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAlertDialog } = props, triggerProps = _objectWithoutProperties(props, _excluded2);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTrigger, _objectSpread2(_objectSpread2(_objectSpread2({}, dialogScope), triggerProps), {}, { ref: forwardedRef }));
});
AlertDialogTrigger.displayName = TRIGGER_NAME;
var PORTAL_NAME = "AlertDialogPortal";
var AlertDialogPortal = (props) => {
	const { __scopeAlertDialog } = props, portalProps = _objectWithoutProperties(props, _excluded3);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogPortal, _objectSpread2(_objectSpread2({}, dialogScope), portalProps));
};
AlertDialogPortal.displayName = PORTAL_NAME;
var OVERLAY_NAME = "AlertDialogOverlay";
var AlertDialogOverlay = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAlertDialog } = props, overlayProps = _objectWithoutProperties(props, _excluded4);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlay, _objectSpread2(_objectSpread2(_objectSpread2({}, dialogScope), overlayProps), {}, { ref: forwardedRef }));
});
AlertDialogOverlay.displayName = OVERLAY_NAME;
var CONTENT_NAME = "AlertDialogContent";
var [AlertDialogContentProvider, useAlertDialogContentContext] = createAlertDialogContext(CONTENT_NAME);
var AlertDialogContent = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAlertDialog, children } = props, contentProps = _objectWithoutProperties(props, _excluded5);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogContentProvider, {
		...
		cancelRef,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContent, _objectSpread2(_objectSpread2(_objectSpread2({ role: "alertdialog" }, dialogScope), contentProps), {}, {
			ref: composedRefs,
			onOpenAutoFocus: composeEventHandlers(contentProps.onOpenAutoFocus, (event) => {
				var _cancelRef$current;
				event.preventDefault();
				(_cancelRef$current = cancelRef.current) === null || _cancelRef$current === void 0 || _cancelRef$current.focus({ preventScroll: true });
			}),
...
var AlertDialogTitle = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAlertDialog } = props, titleProps = _objectWithoutProperties(props, _excluded6);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, _objectSpread2(_objectSpread2(_objectSpread2({}, dialogScope), titleProps), {}, { ref: forwardedRef }));
});
AlertDialogTitle.displayName = TITLE_NAME;
var DESCRIPTION_NAME = "AlertDialogDescription";
var AlertDialogDescription = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAlertDialog } = props, descriptionProps = _objectWithoutProperties(props, _excluded7);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, _objectSpread2(_objectSpread2(_objectSpread2({}, dialogScope), descriptionProps), {}, { ref: forwardedRef }));
});
AlertDialogDescription.displayName = DESCRIPTION_NAME;
var ACTION_NAME = "AlertDialogAction";
var AlertDialogAction = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAlertDialog } = props, actionProps = _objectWithoutProperties(props, _excluded8);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogClose, _objectSpread2(_objectSpread2(_objectSpread2({}, dialogScope), actionProps), {}, { ref: forwardedRef }));
});
AlertDialogAction.displayName = ACTION_NAME;
var CANCEL_NAME = "AlertDialogCancel";
var AlertDialogCancel = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeAlertDialog } = props, cancelProps = _objectWithoutProperties(props, _excluded9);
	const { cancelRef } = useAlertDialogContentContext(CANCEL_NAME, __scopeAlertDialog);
	const dialogScope = useDialogScope(__scopeAlertDialog);
	const ref = useComposedRefs(forwardedRef, cancelRef);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogClose, _objectSpread2(_objectSpread2(_objectSpread2({}, dialogScope), cancelProps), {}, { ref }));
});
