...
import { D as useLayoutEffect2, M as useComposedRefs, N as require_jsx_runtime, O as createContextScope, T as useControllableState, b as Presence, k as Primitive } from "./react-alert-dialog+[...].mjs";
...
var _excluded = [
	...
	"onCheckedChange",
	"form"
], _excluded3 = ["__scopeCheckbox", "forceMount"], _excluded4 = ["__scopeCheckbox"];
...
function CheckboxProvider(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckboxProviderImpl, _objectSpread2(_objectSpread2({ scope: __scopeCheckbox }, context), {}, { children: isFunction(internal_do_not_use_render) ? internal_do_not_use_render(context) : children }));
}
var TRIGGER_NAME = "CheckboxTrigger";
var CheckboxTrigger = import_react.forwardRef((_ref, forwardedRef) => {
	let { __scopeCheckbox, onKeyDown, onClick } = _ref, checkboxProps = _objectWithoutProperties(_ref, _excluded);
...
var Checkbox = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeCheckbox, name, checked, defaultChecked, required, disabled, value, onCheckedChange, form } = props, checkboxProps = _objectWithoutProperties(props, _excluded2);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckboxProvider, {
		...
		form,
		value,
		internal_do_not_use_render: ({ isFormControl }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckboxTrigger, _objectSpread2(_objectSpread2({}, checkboxProps), {}, {
			ref: forwardedRef,
			__scopeCheckbox
...
var CheckboxIndicator = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeCheckbox, forceMount } = props, indicatorProps = _objectWithoutProperties(props, _excluded3);
	const context = useCheckboxContext(INDICATOR_NAME, __scopeCheckbox);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		present: forceMount || isIndeterminate(context.checked) || context.checked === true,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.span, _objectSpread2(_objectSpread2({
			"data-state": getState(context.checked),
			"data-disabled": context.disabled ? "" : void 0
		}, indicatorProps), {}, {
			ref: forwardedRef,
			style: _objectSpread2({ pointerEvents: "none" }, props.style)
		}))
	});
});
CheckboxIndicator.displayName = INDICATOR_NAME;
var BUBBLE_INPUT_NAME = "CheckboxBubbleInput";
var CheckboxBubbleInput = import_react.forwardRef((_ref2, forwardedRef) => {
	let { __scopeCheckbox } = _ref2, props = _objectWithoutProperties(_ref2, _excluded4);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.input, _objectSpread2(_objectSpread2({
		type: "checkbox",
		"aria-hidden": true,
