import { S as _checkPrivateRedeclaration, b as _assertClassBrand, v as _classPrivateFieldGet2, x as _classPrivateFieldInitSpec, y as _classPrivateFieldSet2 } from "../@lovable.dev/mcp-js.mjs";
...
var _excluded = ["state"], _excluded2 = ["fetchStatus"];
...
function dehydrateQuery(query, serializeData, shouldRedactErrors) {
	...
	return _objectSpread2(_objectSpread2(_objectSpread2({
		...
		state: _objectSpread2(_objectSpread2({}, query.state), query.state.data !== void 0 && { data: serializeData(query.state.data) }),
		queryKey: query.queryKey,
		queryHash: query.queryHash
	}, query.state.status === "pending" && { promise: dehydratePromise() }), query.meta && { meta: query.meta }), query.queryType && { queryType: query.queryType });
}
	...
	queries.forEach(({ queryKey, state, queryHash, meta, promise, dehydratedAt, queryType }) => {
		...
		if (query) {
			...
			if (state.dataUpdatedAt > query.state.dataUpdatedAt || hasNewerSyncData) {
				...
				query.setState(_objectSpread2(_objectSpread2({}, serializedState), {}, { data }, state.status === "pending" && data !== void 0 && _objectSpread2({
					status: "success",
			...
			}, state.status === "pending" && data !== void 0 && { dataUpdatedAt: dehydratedAt !== null && dehydratedAt !== void 0 ? dehydratedAt : Date.now() }));
		}
...
var Query = (_queryType = /* @__PURE__ */ new WeakMap(), _initialState = /* @__PURE__ */ new WeakMap(), _revertState = /* @__PURE__ */ new WeakMap(), _cache = /* @__PURE__ */ new WeakMap(), _client$3 = /* @__PURE__ */ new WeakMap(), _retryer$1 = /* @__PURE__ */ new WeakMap(), _defaultOptions$1 = /* @__PURE__ */ new WeakMap(), _abortSignalConsumed = /* @__PURE__ */ new WeakMap(), _Class_brand$3 = /* @__PURE__ */ new WeakSet(), class extends Removable {
	...
	async fetch(options, fetchOptions) {
		...
		try {
			...
			const data = await _classPrivateFieldGet2(_retryer$1, _this).start();
	...
	async execute(variables) {
		...
		try {
			...
			if (restored) onContinue();
				...
				if (_classPrivateFieldGet2(_mutationCache$1, _this).config.onMutate) await _classPrivateFieldGet2(_mutationCache$1, _this).config.onMutate(variables, _this, mutationFnContext);
				const context = await ((_this$options$onMutat = (_this$options = _this.options).onMutate) === null || _this$options$onMutat === void 0 ? void 0 : _this$options$onMutat.call(_this$options, variables, mutationFnContext));
			...
			const data = await _classPrivateFieldGet2(_retryer, _this).start();
			await ((_classPrivateFieldGet3 = (_classPrivateFieldGet4 = _classPrivateFieldGet2(_mutationCache$1, _this).config).onSuccess) === null || _classPrivateFieldGet3 === void 0 ? void 0 : _classPrivateFieldGet3.call(_classPrivateFieldGet4, data, variables, _this.state.context, _this, mutationFnContext));
			await ((_this$options$onSucce = (_this$options2 = _this.options).onSuccess) === null || _this$options$onSucce === void 0 ? void 0 : _this$options$onSucce.call(_this$options2, data, variables, _this.state.context, mutationFnContext));
			await ((_classPrivateFieldGet5 = (_classPrivateFieldGet6 = _classPrivateFieldGet2(_mutationCache$1, _this).config).onSettled) === null || _classPrivateFieldGet5 === void 0 ? void 0 : _classPrivateFieldGet5.call(_classPrivateFieldGet6, data, null, _this.state.variables, _this.state.context, _this, mutationFnContext));
			await ((_this$options$onSettl = (_this$options3 = _this.options).onSettled) === null || _this$options$onSettl === void 0 ? void 0 : _this$options$onSettl.call(_this$options3, data, null, variables, _this.state.context, mutationFnContext));
			_assertClassBrand(_Class_brand$1, _this, _dispatch).call(_this, {
				type: "success",
				data
			});
			...
			try {
				...
				await ((_classPrivateFieldGet7 = (_classPrivateFieldGet8 = _classPrivateFieldGet2(_mutationCache$1, _this).config).onError) === null || _classPrivateFieldGet7 === void 0 ? void 0 : _classPrivateFieldGet7.call(_classPrivateFieldGet8, error, variables, _this.state.context, _this, mutationFnContext));
			} catch (e) {
				Promise.reject(e);
			}
			try {
				var _this$options$onError, _this$options4;
				await ((_this$options$onError = (_this$options4 = _this.options).onError) === null || _this$options$onError === void 0 ? void 0 : _this$options$onError.call(_this$options4, error, variables, _this.state.context, mutationFnContext));
			} catch (e) {
				Promise.reject(e);
			}
			try {
				var _classPrivateFieldGet9, _classPrivateFieldGet10;
				await ((_classPrivateFieldGet9 = (_classPrivateFieldGet10 = _classPrivateFieldGet2(_mutationCache$1, _this).config).onSettled) === null || _classPrivateFieldGet9 === void 0 ? void 0 : _classPrivateFieldGet9.call(_classPrivateFieldGet10, void 0, error, _this.state.variables, _this.state.context, _this, mutationFnContext));
			} catch (e) {
				Promise.reject(e);
			}
			try {
				var _this$options$onSettl2, _this$options5;
				await ((_this$options$onSettl2 = (_this$options5 = _this.options).onSettled) === null || _this$options$onSettl2 === void 0 ? void 0 : _this$options$onSettl2.call(_this$options5, void 0, error, variables, _this.state.context, mutationFnContext));
			} catch (e) {
				Promise.reject(e);
			}
			_assertClassBrand(_Class_brand$1, _this, _dispatch).call(_this, {
...
var QueryClient = (_queryCache = /* @__PURE__ */ new WeakMap(), _mutationCache = /* @__PURE__ */ new WeakMap(), _defaultOptions = /* @__PURE__ */ new WeakMap(), _queryDefaults = /* @__PURE__ */ new WeakMap(), _mutationDefaults = /* @__PURE__ */ new WeakMap(), _mountCount = /* @__PURE__ */ new WeakMap(), _unsubscribeFocus = /* @__PURE__ */ new WeakMap(), _unsubscribeOnline = /* @__PURE__ */ new WeakMap(), class {
	...
	mount() {
		...
		_classPrivateFieldSet2(_unsubscribeFocus, this, focusManager.subscribe(async (focused) => {
			if (focused) {
				await _this.resumePausedMutations();
	...
	*/
	...
	invalidateQueries(filters, options = {}) {
		return notifyManager.batch(() => {
			...
			return this.refetchQueries(_objectSpread2(_objectSpread2({}, filters), {}, { type: (_ref = (_filters$refetchType = filters === null || filters === void 0 ? void 0 : filters.refetchType) !== null && _filters$refetchType !== void 0 ? _filters$refetchType : filters === null || filters === void 0 ? void 0 : filters.type) !== null && _ref !== void 0 ? _ref : "active" }), options);
		});
	}
...
//#endregion
export { dehydrate as a, noop as c, _classPrivateMethodInitSpec as d, notifyManager as i, shouldThrowError as l, MutationObserver as n, hydrate as o, QueryObserver as r, environmentManager as s, QueryClient as t, timeoutManager as u };
