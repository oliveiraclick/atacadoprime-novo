...
import { E as useId, M as useComposedRefs, N as require_jsx_runtime, O as createContextScope, T as useControllableState, k as Primitive, w as useCallbackRef } from "./@radix-ui/react-alert-dialog+[...].mjs";
...
var RovingFocusGroup = import_react.forwardRef((props, forwardedRef) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.Slot, {
			scope: props.__scopeRovingFocusGroup,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RovingFocusGroupImpl, _objectSpread2(_objectSpread2({}, props), {}, { ref: forwardedRef }))
		})
	});
});
RovingFocusGroup.displayName = GROUP_NAME;
var RovingFocusGroupImpl = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeRovingFocusGroup, orientation, loop = false, dir, currentTabStopId: currentTabStopIdProp, defaultCurrentTabStopId, onCurrentTabStopIdChange, onEntryFocus, preventScrollOnEntryFocus = false } = props, groupProps = _objectWithoutProperties(props, _excluded);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RovingFocusProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive.div, _objectSpread2(_objectSpread2({
			...
			ref: composedRefs,
			style: _objectSpread2({ outline: "none" }, props.style),
...
var RovingFocusGroupItem = import_react.forwardRef((props, forwardedRef) => {
	const { __scopeRovingFocusGroup, focusable = true, active = false, tabStopId, children } = props, itemProps = _objectWithoutProperties(props, _excluded2);
	const autoId = useId();
