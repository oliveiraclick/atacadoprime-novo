...
init_objectSpread2();
var _excluded = ["transform"], _excluded2 = [
	"id",
	"accessibility",
	"autoScroll",
	"children",
...
function adjustScale(transform, rect1, rect2) {
	return _objectSpread2(_objectSpread2({}, transform), {}, {
...
function createRectAdjustmentFn(modifier) {
	return function adjustClientRect(rect) {
		for (var _len = arguments.length, adjustments = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) adjustments[_key - 1] = arguments[_key];
		return adjustments.reduce((acc, adjustment) => _objectSpread2(_objectSpread2({}, acc), {}, {
...
var defaultKeyboardCoordinateGetter = (event, _ref) => {
	...
	switch (event.code) {
		case KeyboardCode.Right: return _objectSpread2(_objectSpread2({}, currentCoordinates), {}, { x: currentCoordinates.x + 25 });
		case KeyboardCode.Left: return _objectSpread2(_objectSpread2({}, currentCoordinates), {}, { x: currentCoordinates.x - 25 });
		case KeyboardCode.Down: return _objectSpread2(_objectSpread2({}, currentCoordinates), {}, { y: currentCoordinates.y + 25 });
		case KeyboardCode.Up: return _objectSpread2(_objectSpread2({}, currentCoordinates), {}, { y: currentCoordinates.y - 25 });
	}
};
	...
	const resizeObserver = useResizeObserver({ callback: (0, import_react.useCallback)((entries) => {
		for (const { target } of entries) if (isHTMLElement(target)) {
			setRect((rect) => {
				...
				return rect ? _objectSpread2(_objectSpread2({}, rect), {}, {
					width: newRect.width,
...
function reducer(state, action) {
	switch (action.type) {
		case Action.DragStart: return _objectSpread2(_objectSpread2({}, state), {}, { draggable: _objectSpread2(_objectSpread2({}, state.draggable), {}, {
			initialCoordinates: action.initialCoordinates,
			active: action.active
		}) });
		case Action.DragMove:
			if (state.draggable.active == null) return state;
			return _objectSpread2(_objectSpread2({}, state), {}, { draggable: _objectSpread2(_objectSpread2({}, state.draggable), {}, { translate: {
				x: action.coordinates.x - state.draggable.initialCoordinates.x,
				y: action.coordinates.y - state.draggable.initialCoordinates.y
			} }) });
		case Action.DragEnd:
		case Action.DragCancel: return _objectSpread2(_objectSpread2({}, state), {}, { draggable: _objectSpread2(_objectSpread2({}, state.draggable), {}, {
			active: null,
			initialCoordinates: {
				x: 0,
				y: 0
		...
		case Action.RegisterDroppable: {
			...
			return _objectSpread2(_objectSpread2({}, state), {}, { droppable: _objectSpread2(_objectSpread2({}, state.droppable), {}, { containers }) });
		}
		case Action.SetDroppableDisabled: {
			...
			const containers = new DroppableContainersMap(state.droppable.containers);
			containers.set(id, _objectSpread2(_objectSpread2({}, element), {}, { disabled }));
			return _objectSpread2(_objectSpread2({}, state), {}, { droppable: _objectSpread2(_objectSpread2({}, state.droppable), {}, { containers }) });
		}
...
function applyModifiers(modifiers, _ref) {
	let { transform } = _ref, args = _objectWithoutProperties(_ref, _excluded);
	return modifiers != null && modifiers.length ? modifiers.reduce((accumulator, modifier) => {
		return modifier(_objectSpread2({ transform: accumulator }, args));
	}, transform) : transform;
}
function useMeasuringConfiguration(config) {
	return (0, import_react.useMemo)(() => ({
		draggable: _objectSpread2(_objectSpread2({}, defaultMeasuringConfiguration.draggable), config == null ? void 0 : config.draggable),
		droppable: _objectSpread2(_objectSpread2({}, defaultMeasuringConfiguration.droppable), config == null ? void 0 : config.droppable),
		dragOverlay: _objectSpread2(_objectSpread2({}, defaultMeasuringConfiguration.dragOverlay), config == null ? void 0 : config.dragOverlay)
	}), [
...
var ActiveDraggableContext = /*#__PURE__*/ (0, import_react.createContext)(_objectSpread2(_objectSpread2({}, defaultCoordinates), {}, {
	scaleX: 1,
	scaleY: 1
}));
var Status;
...
var DndContext = /*#__PURE__*/ (0, import_react.memo)(function DndContext(_ref) {
	...
	let { id, accessibility, autoScroll = true, children, sensors = defaultSensors, collisionDetection = rectIntersection, measuring, modifiers } = _ref, props = _objectWithoutProperties(_ref, _excluded2);
	...
	useAutoScroller(_objectSpread2(_objectSpread2({}, autoScrollOptions), {}, {
		delta: translate,
...
function useDroppable(_ref) {
	...
	const { disabled: resizeObserverDisabled, updateMeasurementsFor, timeout: resizeObserverTimeout } = _objectSpread2(_objectSpread2({}, defaultResizeObserverConfig), resizeObserverConfig);
...
//#endregion
export { useDraggable as a, useSensors as c, _objectSpread2 as d, init_objectSpread2 as f, closestCenter as i, require_react_dom as l, init_defineProperty as m, PointerSensor as n, useDroppable as o, _defineProperty as p, TouchSensor as r, useSensor as s, DndContext as t, _objectWithoutProperties as u };
