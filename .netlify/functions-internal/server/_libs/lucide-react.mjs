...
var Icon = (0, import_react.forwardRef)((_ref, ref) => {
	let { color = "currentColor", size = 24, strokeWidth = 2, absoluteStrokeWidth, className = "", children, iconNode } = _ref, rest = _objectWithoutProperties(_ref, _excluded$1);
	return (0, import_react.createElement)("svg", _objectSpread2(_objectSpread2(_objectSpread2({ ref }, defaultAttributes), {}, {
		width: size,
		height: size,
		stroke: color,
		strokeWidth: absoluteStrokeWidth ? Number(strokeWidth) * 24 / Number(size) : strokeWidth,
		className: mergeClasses("lucide", className)
	}, !children && !hasA11yProp(rest) && { "aria-hidden": "true" }), rest), [...iconNode.map(([tag, attrs]) => (0, import_react.createElement)(tag, attrs)), ...Array.isArray(children) ? children : [children]]);
});
//#endregion
...
var createLucideIcon = (iconName, iconNode) => {
	const Component = (0, import_react.forwardRef)((_ref, ref) => {
		let { className } = _ref, props = _objectWithoutProperties(_ref, _excluded);
		return (0, import_react.createElement)(Icon, _objectSpread2({
			ref,
			iconNode,
...
//#endregion
export { PackageCheck as $, Check as $t, Share2 as A, FileDown as At, RefreshCw as B, CloudUpload as Bt, SquareDashed as C, HandCoins as Ct, ShoppingBag as D, FolderTree as Dt, ShoppingCart as E, Funnel as Et, ScanBarcode as F, Download as Ft, Plus as G, CircleUser as Gt, Radar as H, Clock as Ht, Save as I, DollarSign as It, Percent as J, CircleAlert as Jt, PiggyBank as K, CircleQuestionMark as Kt, Route as L, CreditCard as Lt, Send as M, EyeOff as Mt, Search as N, ExternalLink as Nt, Shield as O, Flag as Ot, ScanLine as P, Ellipsis as Pt, PackageSearch as Q, ChevronDown as Qt, RotateCcw as R, Copy as Rt, Star as S, Handshake as St, Smartphone as T, Gauge as Tt, QrCode as U, ClipboardList as Ut, Receipt as V, CloudOff as Vt, Printer as W, CircleX as Wt, Pen as X, ChevronRight as Xt, Pencil as Y, ChevronUp as Yt, Package as Z, ChevronLeft as Zt, Trash2 as _, ArrowDownRight as _n, Info as _t, WifiOff as a, Briefcase as an, Megaphone as at, Tag as b, House as bt, Users as c, Bell as cn, Mail as ct, UserCheck as d, ArrowUpRight as dn, LoaderCircle as dt, ChartColumn as en, Navigation as et, Trophy as f, ArrowUpDown as fn, ListChecks as ft, TrendingDown as g, ArrowDown as gn, Landmark as gt, TrendingUp as h, ArrowLeftRight as hn, LayoutDashboard as ht, Wifi as i, Building2 as in, Menu as it, Settings as j, Eye as jt, ShieldCheck as k, FileText as kt, User as l, Banknote as ln, LogOut as lt, TriangleAlert as m, ArrowLeft as mn, LayoutGrid as mt, X as n, CalendarClock as nn, MessageSquare as nt, Warehouse as o, Brain as on, Map as ot, Truck as p, ArrowRight as pn, LifeBuoy as pt, Phone as q, CircleCheck as qt, Workflow as r, Calculator as rn, MessageCircle as rt, Wallet as s, Boxes as sn, MapPin as st, Zap as t, Calendar as tn, Minus as tt, UserPlus as u, ArrowUp as un, LogIn as ut, Timer as v, Activity as vn, Image as vt, Sparkles as w, Globe as wt, Stethoscope as x, Heart as xt, Target as y, ImageOff as yt, Rocket as z, Cog as zt };
