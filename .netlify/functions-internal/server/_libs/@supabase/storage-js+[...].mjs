import { d as _objectSpread2$1, f as init_objectSpread2 } from "../@dnd-kit/core.mjs";
...
function createFetchClient(options) {
	...
	return { async request({ method, path, query, body, headers }) {
		...
		const res = await fetchFn(url, {
			method,
			headers: _objectSpread2$1(_objectSpread2$1(_objectSpread2$1({}, body ? { "Content-Type": "application/json" } : {}), authHeaders), headers),
...
var NamespaceOperations = class {
	...
	async listNamespaces(parent) {
		...
		return (await _this.client.request({
			method: "GET",
	...
	async createNamespace(id, metadata) {
		...
		return (await _this2.client.request({
			method: "POST",
	...
	async loadNamespaceMetadata(id) {
		var _this4 = this;
		return { properties: (await _this4.client.request({
			method: "GET",
	...
	async createNamespaceIfNotExists(id, metadata) {
		var _this6 = this;
		try {
			return await _this6.createNamespace(id, metadata);
		} catch (error) {
...
var TableOperations = class {
	...
	async listTables(namespace) {
		var _this7 = this;
		return (await _this7.client.request({
			method: "GET",
	...
	async createTable(namespace, request) {
		...
		return (await _this8.client.request({
			method: "POST",
	...
	async updateTable(id, request) {
		var _this9 = this;
		const response = await _this9.client.request({
			method: "POST",
	...
	async loadTable(id) {
		...
		return (await _this11.client.request({
			method: "GET",
	...
	async createTableIfNotExists(namespace, request) {
		var _this13 = this;
		try {
			return await _this13.createTable(namespace, request);
		} catch (error) {
			if (error instanceof IcebergError && error.status === 409) return await _this13.loadTable({
...
var StorageVectorsClient = class extends VectorBucketApi {
	...
	*/
	async createBucket(vectorBucketName) {
		var _superprop_getCreateBucket2 = () => super.createBucket, _this54 = this;
		var _superprop_getCreateBucket = () => _superprop_getCreateBucket2(), _this = _this54;
	...
	*/
	async getBucket(vectorBucketName) {
		var _superprop_getGetBucket2 = () => super.getBucket, _this55 = this;
		var _superprop_getGetBucket = () => _superprop_getGetBucket2(), _this2 = _this55;
	...
	*/
	async listBuckets(options = {}) {
		var _superprop_getListBuckets2 = () => super.listBuckets, _this56 = this;
		var _superprop_getListBuckets = () => _superprop_getListBuckets2(), _this3 = _this56;
	...
	*/
	async deleteBucket(vectorBucketName) {
		var _superprop_getDeleteBucket2 = () => super.deleteBucket, _this57 = this;
		var _superprop_getDeleteBucket = () => _superprop_getDeleteBucket2(), _this4 = _this57;
...
var VectorBucketScope = class extends VectorIndexApi {
	...
	*/
	async createIndex(options) {
		var _superprop_getCreateIndex2 = () => super.createIndex, _this58 = this;
		var _superprop_getCreateIndex = () => _superprop_getCreateIndex2(), _this5 = _this58;
	...
	*/
	async listIndexes(options = {}) {
		var _superprop_getListIndexes2 = () => super.listIndexes, _this59 = this;
		var _superprop_getListIndexes = () => _superprop_getListIndexes2(), _this6 = _this59;
	...
	*/
	async getIndex(indexName) {
		var _superprop_getGetIndex2 = () => super.getIndex, _this60 = this;
		var _superprop_getGetIndex = () => _superprop_getGetIndex2(), _this7 = _this60;
	...
	*/
	async deleteIndex(indexName) {
		var _superprop_getDeleteIndex2 = () => super.deleteIndex, _this61 = this;
		var _superprop_getDeleteIndex = () => _superprop_getDeleteIndex2(), _this8 = _this61;
...
var VectorIndexScope = class extends VectorDataApi {
	...
	*/
	async putVectors(options) {
		var _superprop_getPutVectors2 = () => super.putVectors, _this62 = this;
		var _superprop_getPutVectors = () => _superprop_getPutVectors2(), _this9 = _this62;
	...
	*/
	async getVectors(options) {
		var _superprop_getGetVectors2 = () => super.getVectors, _this63 = this;
		var _superprop_getGetVectors = () => _superprop_getGetVectors2(), _this10 = _this63;
	...
	*/
	async listVectors(options = {}) {
		var _superprop_getListVectors2 = () => super.listVectors, _this64 = this;
		var _superprop_getListVectors = () => _superprop_getListVectors2(), _this11 = _this64;
	...
	*/
	async queryVectors(options) {
		var _superprop_getQueryVectors2 = () => super.queryVectors, _this65 = this;
		var _superprop_getQueryVectors = () => _superprop_getQueryVectors2(), _this12 = _this65;
	...
	*/
	async deleteVectors(options) {
		var _superprop_getDeleteVectors2 = () => super.deleteVectors, _this66 = this;
		var _superprop_getDeleteVectors = () => _superprop_getDeleteVectors2(), _this13 = _this66;
